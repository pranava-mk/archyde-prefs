if command -v "bat" &>/dev/null; then
    ...
    #! alias -g -- --help='--help 2>&1 | bat --language=help --style=plain --paging=never --color always' # <--- breaks scripts: global aliases expand inside case patterns during source-time parsing
